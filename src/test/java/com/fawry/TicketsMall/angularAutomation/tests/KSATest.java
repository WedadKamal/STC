...
public class KSATest extends BaseTest{


    ArrayList KSATestData = new ArrayList();
    String actualResults;
    @BeforeClass(alwaysRun = true)
    public void navigateToKSAPage(){
        ...
        navigatedToPageSuccessfully = STCHomePage.selectKSACountry();
        Assert.assertEquals(navigatedToPageSuccessfully, GeneralConstants.SUCCESS, "Could not navigate to KSA Page successfully");
    }

    @Test(description = "Validate KSA functionalities",priority = 0  ,dataProvider = "KSADP" ,enabled = true)
    public void verifyKSAFunctionality(STCHomePageDM STCHomePageDM) {
    ...
    @DataProvider(name = "KSADP")
    public Object[][] provideKSATD() {
        Object[][] STCHomePageDP = new Object[KSATestData.size()][1];
        for (int i = 0; i < KSATestData.size(); i++)
            STCHomePageDP[i][0] = KSATestData.get(i);
    ...
    public void KSATD() {
        ...
        ArrayList<ArrayList<Object>> resultArray = provideTestData("KSATestData");
