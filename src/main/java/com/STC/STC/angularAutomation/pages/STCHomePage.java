...
public class STCHomePage extends MainPage{
    ...
    public String countryFlag(STCHomePageDM STCHomePageDM) {
        try {

            if(STCHomePageDM.getCountryName().equalsIgnoreCase("KUWAIT")){
            Log.info("Navigate to Kuwait page");
            selectCountry(kuwaitCountry);}
            else if(STCHomePageDM.getCountryName().equalsIgnoreCase("KSA")){
                Log.info("Navigate to KSA page");
                selectCountry(KSACountry);}
            else if (STCHomePageDM.getCountryName().equalsIgnoreCase("BAHRAIN")){
