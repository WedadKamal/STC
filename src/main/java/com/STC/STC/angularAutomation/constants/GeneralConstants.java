package com.STC.STC.angularAutomation.constants;
...
public class GeneralConstants {
	...
	public static final String HOT_EVENT = "1";
	public static final String UNHOT_EVENT = "0";
	public static final String STATUS_PENDING = "PENDING";
	public static final String STATUS_REFUSED = "REFUSED";
	public static final String PAYMENT_STATUS_INVITATION = "Invitation";
	...
	public static final String EXPECTED_ACTIVE_CATEGORY_STATUS ="1";
	...
	public static final String CATEGORY_SAMPLE_TEXT = "Category Code, Name En, Name Ar, Image URL";
	public static final String ImportedFileName = "ImportCategory.xlsx";
	public static final String CATEGORY_CODE = "Category Code";
	public static final String CATEGORY_EN_NAME = "Name En";
	public static final String CATEGORY_AR_NAME = "Name Ar";
	public static final String CATEGORY_IMAGE_URL = "Image URL";
	public static final String CATEGORY_EN_NAME_CONTENT = "CategoryNameEn";
	public static final String CATEGORY_AR_NAME_CONTENT = "CategoryNameAr";
	public static final String FULL_DAY = "FULL DAY";
	public static final String EVENT_EN_NAME = "UpdateEnEventName";
	public static final String EXPECTED_EVENT_UPDATED_MSG = "Success#Operation done successfully";
	public static final String EXPECTED_EVENT_DELETED_MSG = "Confirmed#Event has been successfully deleted";
	public static final String EXPECTED_EVENT_HOT_UNHOT_MSG = "Confirmed#Event has been successfully updated";
	public static final String PICK_DATE_DEFAULT = "Enter date";
	public static final String CATEGORY_IMAGE_CONTENT = "http://10.95.0.178/STCpay-api/2000008261/categories/32a8a54be9ed44fcb1f8e796dedceb81.png";
...
// **********************************************************************************************************
	...
	public static final String NUMBER_OF_TICKETS = "1";
